...
<body>
<div class="heading2"><h2>BSIT EVENING A</h2></div>
	<div class="search">
	<form class="form-inline" action="it_eve_a.php" method="get">
  ...
  <button type="submit" name="sub" class="btn btn-primary">Search Here</button>
	...
	include("include/db.php");
		if(isset($_GET['sub'])){
			 $search = $_GET['search'];
			 $que = "select * from it_eve_a where cnic='$search' OR roll='$search'";
			 $run = mysql_query($que);
	...
	<tr class="info">
		...
		<tr>
			<td align="center" colspan="12"><a href="it_eve_a.php">OK</a></td>
		</tr>
	</table><br><br>
		<?php }} ?>
		<div class="container">
...
?>
	    ...
	    <td><?php echo $nat; ?></td>
	    <td><?php echo $relig; ?></td>
		<td><a href='del_it_eve_a.php?del_it_eve_a=<?php echo $id; ?>'><font color="#2A7B9B">Delete</font></a></td>
	    <td><a href='edit_it_eve_a.php?edit_it_eve_a=<?php echo $id; ?>'><font color="#2A7B9B">Delete</font></a></td>
      </tr>
  <?php }  ?>	
</table>
</div>
...
<center><font color="#2A7B9B" size="8px"><?php echo @$_GET['edit']; ?></font></center>
		...
		<div class="dropdown">
			...
			<li><a href="#it_evening_A" data-toggle="modal">Insert Students</a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="name22" id="name22" placeholder="Example:Tahir Jutt">
  </div>
  <div class="form-group">
    <label for="rollno22">Roll No:</label>
    <input type="text" name="roll22" class="form-control" id="rollno22" placeholder="Example:473">
  </div>
  <div class="form-group">
    <label for="cnic22">CNIC:</label>
    <input type="text" name="cnic22" class="form-control" id="cnic22" placeholder="Example:00000-0000000-0">
  </div>
  <div class="form-group">
    <label for="add22">Address:</label>
    <input type="text" name="add22" class="form-control" id="add22" placeholder="Type Here">
  </div>
  <div class="form-group">
    <label for="cntct22">Contact:</label>
    <input type="text" name="cntct22" class="form-control" id="cntct22" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
  <div class="form-group">
    <label for="session22">Session:</label>
    <input type="text" name="session22" class="form-control" id="session22" placeholder="Example:2011">
  </div>
  <div class="form-group">
    <label for="fname22">Father Name:</label>
    <input type="text" name="fname22" class="form-control" id="fname22" placeholder="Example:Faqeer Muhammad">
  </div>
  <div class="form-group">
    <label for="fcntct22">Father Contact:</label>
    <input type="text" name="fcntct22" class="form-control" id="fcntct22" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
  <div class="form-group">
    <label for="nat22">Nationality:</label>
    <input type="text" name="nat22" class="form-control" id="nat22" placeholder="Example:Pakistani">
  </div>
  <div class="form-group">
    <label for="relig22">Religion:</label>
    <input type="text" name="relig22" class="form-control" id="relig22"  placeholder="Example:Islam">
  </div>

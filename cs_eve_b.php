...
<body>
<div class="heading1"><h2>BSCS EVENING B</h2></div>
	<div class="search">
	<form class="form-inline" action="cs_eve_b.php" method="get">
  ...
  <button type="submit" name="sub" class="btn btn-danger">Search Here</button>
	...
	include("include/db.php");
		if(isset($_GET['sub'])){
			 $search = $_GET['search'];
			 $que = "select * from cs_eve_b where cnic='$search' OR roll='$search'";
			 $run = mysql_query($que);
	...
	<tr class="info">
		...
		<tr>
			<td align="center" colspan="12"><a href="cs_eve_b.php">OK</a></td>
		</tr>
	</table><br><br>
		<?php }} ?>
		<div class="container">
...
?>
	    ...
	    <td><?php echo $nat; ?></td>
	    <td><?php echo $relig; ?></td>
		<td><a href='del_cs_eve_a.php?del_cs_eve_b=<?php echo $id; ?>'><font color="#E43C39">Delete</font></a></td>
	    <td><a href='edit_cs_eve_b.php?edit_cs_eve_b=<?php echo $id; ?>'><font color="#E43C39">Edit</font></a></td>
      </tr>
  <?php }  ?>	
</table>
</div>
...
<center><font color="#E43C39" size="8px"><?php echo @$_GET['del']; ?></td></font></center>
		...
		<div class="dropdown">
			...
			<li><a href="#cs_evening_B" data-toggle="modal">Insert Students</a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="name13" id="name13" placeholder="Example:Tahir Jutt">
  </div>
  <div class="form-group">
    <label for="rollno13">Roll No:</label>
    <input type="text" name="roll13" class="form-control" id="rollno13" placeholder="Example:473">
  </div>
  <div class="form-group">
    <label for="cnic13">CNIC:</label>
    <input type="text" name="cnic13" class="form-control" id="cnic13" placeholder="Example:00000-0000000-0">
  </div>
  <div class="form-group">
    <label for="add13">Address:</label>
    <input type="text" name="add13" class="form-control" id="add13" placeholder="Type Here">
  </div>
  <div class="form-group">
    <label for="cntct13">Contact:</label>
    <input type="text" name="cntct13" class="form-control" id="cntct13" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
  <div class="form-group">
    <label for="session13">Session:</label>
    <input type="text" name="session13" class="form-control" id="session13" placeholder="Example:2011">
  </div>
  <div class="form-group">
    <label for="fname13">Father Name:</label>
    <input type="text" name="fname13" class="form-control" id="fname13" placeholder="Example:Faqeer Muhammad">
  </div>
  <div class="form-group">
    <label for="fcntct13">Father Contact:</label>
    <input type="text" name="fcntct13" class="form-control" id="fcntct13" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
  <div class="form-group">
    <label for="nat13">Nationality:</label>
    <input type="text" name="nat13" class="form-control" id="nat13" placeholder="Example:Pakistani">
  </div>
  <div class="form-group">
    <label for="relig13">Religion:</label>
    <input type="text" name="relig13" class="form-control" id="relig13"  placeholder="Example:Islam">
  </div>
...
include("include/db.php");
  $total_num_results=23;
       ...
       $query=mysql_query("select * from cs_eve_b"); //query to show results from.

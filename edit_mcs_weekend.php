...
include("include/db.php");
	$edit_std	=	@$_GET['edit_mcs_weekend'];
		$que	=	"select * from mcs_weekend where id='$edit_std'";
		$run = mysql_query($que);
...
<body>
		...
		<div class="container">
		<div class="form">
		<form method="post" action="edit_mcs_weekend.php?edit_mcs_weekend=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading">Updating Mcs Weekend's Record</h2></div>
		</center><br />
...
if(isset($_POST['update'])){
			$edit_id1 = $_GET['edit_mcs_weekend'];
			$name=$_POST['name']; 
			$roll=$_POST['roll']; 
			$cnic=$_POST['cnic'];
			$add=$_POST['add'];
		...
		$que1 = "update mcs_weekend set name='$name',roll='$roll',cnic='$cnic',address='$add',cntct='$cntct',session='$session',
		fname='$fname',fcntct='$fcntct',nationality='$nat',religion='$relig' where id='$edit_id1'";
			if(mysql_query($que1)){
				header('location:mcs_weekend.php?edit=Data has been Updated Successfully!!!');
			}
	}

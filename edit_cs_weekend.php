...
include("include/db.php");
	$edit_std	=	@$_GET['edit_cs_weekend'];
		$que	=	"select * from cs_weekend where id='$edit_std'";
		$run = mysql_query($que);
...
<body>
		...
		<div class="container">
		<div class="form">
		<form method="post" action="edit_cs_weekend.php?edit_cs_weekend=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading1">Updating BSCS Weekend's Record</h2></div>
		</center><br />
...
if(isset($_POST['update'])){
		...
		$que1 = "update cs_weekend set name='$name',roll='$roll',cnic='$cnic',address='$add',cntct='$cntct',session='$session',
		fname='$fname',fcntct='$fcntct',nationality='$nat',religion='$relig' where id='$edit_id1'";
			if(mysql_query($que1)){
				header('location:cs_weekend.php?edit=Data has been Updated Successfully!!!');
			}
	}

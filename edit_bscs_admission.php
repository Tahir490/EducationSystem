...
include("include/db.php");
	$id	=	@$_GET['edit_bscs_admission'];
		$que	=	"select * from bscs_admisson where id='$id'";
		$run = mysql_query($que);
...
<div class="container">
		<div class="form">
		<form method="post" action="edit_bscs_admission.php?edit_bscs_admission=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading1">Viewing BSCS Admissions</h2></div>
		</center><br />

...
<body>
<div class="heading1"><h2>BSCS COURSES</h2></div>
	<div class="search">
	<form class="form-inline" action="cs_course.php" method="get">
  ...
  <button type="submit" name="sub" class="btn btn-danger">Search Here</button>
	...
	include("include/db.php");
		if(isset($_GET['sub'])){
			 $search = $_GET['search'];
			 $que = "select * from cs_course where course_id='$search'";
			 $run = mysql_query($que);
	...
	<tr class="info">
			<td><?php echo @$cs_c_id; ?></td>
			<td><?php echo @$cs_c_name; ?></td>
			<td><?php echo @$cs_c_time; ?></td>
			<td><?php echo @$cs_c_date; ?></td>
			<td><?php echo @$cs_c_duration; ?></td>
			<td><?php echo @$cs_c_fee; ?></td>
			<td><?php echo @$cs_c_instructor; ?></td>
			<td><?php echo @$cs_c_room; ?></td>
			<td><?php echo @$cs_c_lectures; ?></td>
			
			
		</tr>
		<tr>
			<td align="center" colspan="12"><a href="cs_course.php">OK</a></td>
		</tr>
	</table><br><br>
		<?php }} ?>
		<div class="container">
...
?>
		...
		<td><a href='del_cs_course.php?del_cs_course=<?php echo $id; ?>'><font color="#E43C39">Delete</font></a></td>
	    <td><a href='edit_cs_course.php?edit_cs_course=<?php echo $id; ?>'><font color="#E43C39">Edit</font></a></td>
      </tr>
  <?php }  ?>	
</table>
</div>
...
<center><font color="#E43C39" size="8px"><?php echo @$_GET['edit']; ?></td></font></center>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="cs_c_id" id="cs_c_id" placeholder="Example:Course-12345">
  </div>
  <div class="form-group">
    <label for="cs_c_name">Course Name:</label>
    <input type="text" name="cs_c_name" class="form-control" id="cs_c_name" placeholder="Example:Web Designing">
  </div>
  <div class="form-group">
    <label for="cs_c_time">Delivering Time:</label>
    <input type="text" name="cs_c_time" class="form-control" id="cs_c_time" placeholder="Example:10:00 am">
  </div>
  <div class="form-group">
    <label for="cs_c_date">Delivering Date:</label>
    <input type="text" name="cs_c_date" class="form-control" id="cs_c_date" placeholder="12/09/15">
  </div>
  <div class="form-group">
    <label for="cs_c_duration">Duration of Course:</label>
    <input type="text" name="cs_c_duration" class="form-control" id="cs_c_duration" placeholder="Example:6 Months">
  </div>
  <div class="form-group">
    <label for="cs_c_fee">Fee of Course:</label>
    <input type="text" name="cs_c_fee" class="form-control" id="cs_c_fee" placeholder="Example:Rs.6,000">
  </div>
  <div class="form-group">
    <label for="cs_c_instructor">Course Instructor:</label>
    <input type="text" name="cs_c_instructor" class="form-control" id="cs_c_instructor" placeholder="Example:Sir Haroon ">
  </div>
  <div class="form-group">
    <label for="cs_c_room">Room for Delivering Course:</label>
    <input type="text" name="cs_c_room" class="form-control" id="cs_c_room" placeholder="Example:Unix Lab">
  </div>
  <div class="form-group">
    <label for="cs_c_lectures">No. of Lectures/Course:</label>
    <input type="text" name="cs_c_lectures" class="form-control" id="cs_c_lectures" placeholder="Example:32 Lectures">
  </div>
...
include("include/db.php");
  $total_num_results=23;
       ...
       $query=mysql_query("select * from cs_course"); //query to show results from.

...
include("include/db.php");
	$edit_std	=	@$_GET['edit_mcs_eve_b'];
		$que	=	"select * from mcs_eve_b where id='$edit_std'";
		$run = mysql_query($que);
...
<body>
		...
		<div class="container">
		<div class="form">
		<form method="post" action="edit_mcs_eve_b.php?edit_mcs_eve_b=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading">Updating Mcs Evening B's Record</h2></div>
		</center><br />
  ...
  <div class="form-group">
    ...
    <input type="text" name="fcntct" class="form-control" id="fcntct"  or 0300-1234567" value="<?php echo @$fcntct; ?>">
  </div>
  <div class="form-group">
...
if(isset($_POST['update'])){
		...
		$que1 = "update mcs_eve_b set name='$name',roll='$roll',cnic='$cnic',address='$add',cntct='$cntct',session='$session',
		fname='$fname',fcntct='$fcntct',nationality='$nat',religion='$relig' where id='$edit_id1'";
			if(mysql_query($que1)){
				header('location:mcs_eve_b.php?edit=Data has been Updated Successfully!!!');
			}
	}

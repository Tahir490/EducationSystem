...
<body>
<div class="heading2"><h2>BSIT Admissions</h2></div>
...
$query ="select * from bsit_admisson";
...
?>
	    ...
	    <td><a href='edit_bsit_admissions.php?edit_bsit_admission=<?php echo $id; ?>'><font color="#408C40">Show</font></a></td></a></td>
      </tr>
  <?php }  ?>	
</table>
...
include("include/db.php");
  $total_num_results=23;
       ...
       $query=mysql_query("select * from bsit_admisson"); //query to show results from.

...
include("include/db.php");
	$edit_std	=	@$_GET['edit_it_morn'];
		$que	=	"select * from it_morning where id='$edit_std'";
		$run = mysql_query($que);
...
<body>
		...
		<div class="container">
		<div class="form">
		<form method="post" action="edit_it_morn.php?edit_it_morn=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading2">Updating BSIT Morning's Record</h2></div>
		</center><br />
...
if(isset($_POST['update'])){
		...
		$que1 = "update it_morning set name='$name',roll='$roll',cnic='$cnic',address='$add',cntct='$cntct',session='$session',
		fname='$fname',fcntct='$fcntct',nationality='$nat',religion='$relig' where id='$edit_id1'";
			if(mysql_query($que1)){
				header('location:it_morn.php?edit=Data has been Updated Successfully!!!');
			}
	}

...
include("include/db.php");
	$edit_std	=	@$_GET['edit_it_eve_b'];
		$que	=	"select * from it_eve_b where id='$edit_std'";
		$run = mysql_query($que);
...
<body>
		...
		<div class="container">
		<div class="form">
		<form method="post" action="edit_it_eve_b.php?edit_it_eve_b=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading2">Updating BSIT Evening B's Record</h2></div>
		</center><br />
...
if(isset($_POST['update'])){
		...
		$que1 = "update it_eve_b set name='$name',roll='$roll',cnic='$cnic',address='$add',cntct='$cntct',session='$session',

...
include("include/db.php");
	$edit_std	=	@$_GET['edit_it_weekend'];
		$que	=	"select * from it_weekend where id='$edit_std'";
		$run = mysql_query($que);
...
<body>
		...
		<div class="container">
		<div class="form">
		<form method="post" action="edit_it_weekend.php?edit_it_weekend=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading2">Updating BSIT Weekend's Record</h2></div>
		</center><br />
...
if(isset($_POST['update'])){
		...
		$que1 = "update it_weekend set name='$name',roll='$roll',cnic='$cnic',address='$add',cntct='$cntct',session='$session',
		fname='$fname',fcntct='$fcntct',nationality='$nat',religion='$relig' where id='$edit_id1'";
			if(mysql_query($que1)){
				header('location:it_eve_b.php?edit=Data has been Updated Successfully!!!');
			}
	}

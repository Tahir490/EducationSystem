...
<body>
	...
	<div class="heading2"><h2>BSIT EVENING B</h2></div>
	<div class="search">
	<form class="form-inline" action="it_eve_b.php" method="get">
  ...
  <button type="submit" name="sub" class="btn btn-primary">Search Here</button>
	...
	include("include/db.php");
		if(isset($_GET['sub'])){
			 $search = $_GET['search'];
			 $que = "select * from it_eve_b where cnic='$search' OR roll='$search'";
			 $run = mysql_query($que);
	...
	<tr class="info">
		...
		<tr>
			<td align="center" colspan="12"><a href="it_eve_b.php">OK</a></td>
		</tr>
	</table><br><br>
		<?php }} ?>
		<div class="container">
...
?>
	    ...
	    <td><?php echo $nat; ?></td>
	    <td><?php echo $relig; ?></td>
		<td><a href='del_it_eve_b.php?del_it_eve_b=<?php echo $id; ?>'><font color="#2A7B9B">Delete</font></a></td>
	    <td><a href='edit_it_eve_b.php?edit_it_eve_b=<?php echo $id; ?>'><font color="#2A7B9B"><font color="#2A7B9B">Edit</font></font></a></td>
      </tr>
  <?php }  ?>	
</table>
</div>
...
<center><font color="#2A7B9B" size="8px"><?php echo @$_GET['del']; ?></font></center>
		...
		<div class="dropdown">
			...
			<li><a href="#it_evening_B" data-toggle="modal">Insert Students</a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="name23" id="name23" placeholder="Example:Tahir Jutt">
  </div>
  <div class="form-group">
    <label for="rollno23">Roll No:</label>
    <input type="text" name="roll23" class="form-control" id="rollno23" placeholder="Example:473">
  </div>
  <div class="form-group">
    <label for="cnic23">CNIC:</label>
    <input type="text" name="cnic23" class="form-control" id="cnic23" placeholder="Example:00000-0000000-0">
  </div>
  <div class="form-group">
    <label for="add23">Address:</label>
    <input type="text" name="add23" class="form-control" id="add23" placeholder="Type Here">
  </div>
  <div class="form-group">
    <label for="cntct23">Contact:</label>
    <input type="text" name="cntct23" class="form-control" id="cntct23" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
  <div class="form-group">
    <label for="session23">Session:</label>
    <input type="text" name="session23" class="form-control" id="session23" placeholder="Example:2011">
  </div>
  <div class="form-group">
    <label for="fname23">Father Name:</label>
    <input type="text" name="fname23" class="form-control" id="fname23" placeholder="Example:Faqeer Muhammad">
  </div>
  <div class="form-group">
    <label for="fcntct23">Father Contact:</label>
    <input type="text" name="fcntct23" class="form-control" id="fcntct23" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
  <div class="form-group">
    <label for="nat23">Nationality:</label>
    <input type="text" name="nat23" class="form-control" id="nat23" placeholder="Example:Pakistani">
  </div>
  <div class="form-group">
    <label for="relig23">Religion:</label>
    <input type="text" name="relig23" class="form-control" id="relig23"  placeholder="Example:Islam">
  </div>
...
include("include/db.php");
  $total_num_results=23;
       ...
       $query=mysql_query("select * from it_eve_a"); //query to show results from.

...
include("include/db.php");
	$id	=	@$_GET['edit_mcs_user'];
		$que	=	"select * from mcs_admisson where id='$id'";
		$run = mysql_query($que);
...
<div class="container">
		<div class="form">
		<form method="post" action="edit_mcs_user.php?edit_mcs_user=<?php echo $email; ?>" >
		<center>
			<div><h2 class="heading">Viewing Mcs Admissions</h2></div>
		</center><br />
		<h4>Personal Information:</h4>
		<div class="form-group">
		<label for="name3">Name of candidate:</label>
		
		 <input class="form-control" id="disabledInput" type="text"  value="<?php echo @$option; ?><?php echo @$name; ?>" >
		</div>
				<table>
				<th>Picture:</th>
				<td width="100" rowspan=""><center>
		<a href="<?php echo $img;?>">
		<img src="<?php echo $img; ?>" width="100" height="100" border="0"></a></center>
		</td></table>
		<div class="form-group">
		<label for="name3">Father's Name:</label>
		<input class="form-control" id="disabledInput1" type="text"  value="<?php echo @$fname; ?>" >
		</div>

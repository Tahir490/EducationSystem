...
<div id="bodymiddlePan">
	<h2>Gallery</h2>
	<img class="img" src="images/2.jpg" alt="Gallery" title="Gallery" border="4" /><img class="img" src="images/3.jpg" alt="Gallery" title="Gallery" border="4"/>
	<img class="img" src="images/4.jpg" alt="Gallery" title="Gallery" border="4"/><img class="img" src="images/5.gif" alt="Gallery" title="Gallery" border="4"/>
	<img class="img" src="images/6.jpg" alt="Gallery" title="Gallery" border="4"/><img class="img" src="images/7.jpg" alt="Gallery" title="Gallery" border="4"/>
	<p></p>
	<p></p>
</div>

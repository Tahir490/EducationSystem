...
include("include/db.php");
	$edit_std	=	@$_GET['edit_cs_eve_a'];
		$que	=	"select * from cs_eve_a where id='$edit_std'";
		$run = mysql_query($que);
...
<body>
		...
		<div class="container">
		<div class="form">
		<form method="post" action="edit_cs_eve_a.php?edit_cs_eve_a=<?php echo $id; ?>" >
		<center>
			<div><h2 class="heading1">Updating BSCS Evening A's Record</h2></div>
		</center><br />
...
if(isset($_POST['update'])){
		...
		$que1 = "update cs_eve_a set name='$name',roll='$roll',cnic='$cnic',address='$add',cntct='$cntct',session='$session',
		fname='$fname',fcntct='$fcntct',nationality='$nat',religion='$relig' where id='$edit_id1'";
			if(mysql_query($que1)){
				header('location:cs_eve_a.php?edit=Data has been Updated Successfully!!!');
			}
	}

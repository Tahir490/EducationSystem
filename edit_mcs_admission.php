...
<div class="container">
		<div class="form">
		<form method="post" action="edit_mcs_admission.php?edit_mcs_admission=<?php echo $id; ?>" >
		<center>
		...
		<label for="name3">Name of candidate:</label>
		 ...
		 <input class="form-control" id="disabledInput" type="text"  value="<?php echo @$option; ?><?php echo @$name; ?>" disabled>
		</div>
				<table>
				<th>Picture:</th>

...
<body>
	...
	<div class="heading"><h2>MCS Evening A</h2></div>
	<div class="search">
	<form class="form-inline" action="mcs_eve_a.php" method="get">
  ...
  <button type="submit" name="sub" class="btn btn-success">Search Here</button>
	...
	include("include/db.php");
		if(isset($_GET['sub'])){
			 $search = $_GET['search'];
			 $que = "select * from mcs_eve_a where cnic='$search' OR roll='$search'";
			 $run = mysql_query($que);
	...
	<tr class="info">
		...
		<tr>
			<td align="center" colspan="12"><a href="mcs_eve_a.php">OK</a></td>
		</tr>
	</table><br><br>
		<?php }} ?>
		<div class="container">
...
?>
	    ...
	    <td><?php echo $nat; ?></td>
	    <td><?php echo $relig; ?></td>
		<td><a href='del_mcs_eve_a.php?del_mcs_eve_a=<?php echo $id; ?>'><font color="#408C40">Delete</font></a></td></a></td>
	    <td><a href='edit_mcs_eve_a.php?edit_mcs_eve_a=<?php echo $id; ?>'><font color="#408C40">Edit</font></a></td></a></td>
      </tr>
  <?php }  ?>	
</table>
</div>
	...
	<center><font color="#408C40" size="8px"><?php echo @$_GET['edit']; ?></font></center>
		...
		<div class="dropdown">
			...
			<ul class="dropdown-menu">
				<li><a href="#mcs_evening_A" data-toggle="modal">Insert Students</a></li>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="name1" id="name1" placeholder="Example:Tahir Jutt">
  </div>
  <div class="form-group">
    <label for="rollno1">Roll No:</label>
    <input type="text" name="roll1" class="form-control" id="rollno1" placeholder="Example:473">
  </div>
  <div class="form-group">
    <label for="cnic1">CNIC:</label>
    <input type="text" name="cnic1" class="form-control" id="cnic1" placeholder="Example:00000-0000000-0">
  </div>
  <div class="form-group">
    <label for="add1">Address:</label>
    <input type="text" name="add1" class="form-control" id="add1" placeholder="Type Here">
  </div>
  <div class="form-group">
    <label for="cntct1">Contact:</label>
    <input type="text" name="cntct1" class="form-control" id="cntct1" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
  <div class="form-group">
    <label for="session1">Session:</label>
    <input type="text" name="session1" class="form-control" id="session1" placeholder="Example:2011">
  </div>
  <div class="form-group">
    <label for="fname1">Father Name:</label>
    <input type="text" name="fname1" class="form-control" id="fname1" placeholder="Example:Faqeer Muhammad">
  </div>
  <div class="form-group">
    <label for="fcntct1">Father Contact:</label>
    <input type="text" name="fcntct1" class="form-control" id="fcntct1" placeholder="Example:068-1234567 or 0300-1234567">
  </div>
   <div class="form-group">
    <label for="nat1">Nationality:</label>
    <input type="text" name="nat1" class="form-control" id="nat1" placeholder="Example:Pakistani">
  </div>
  <div class="form-group">
    <label for="relig1">Religion:</label>
    <input type="text" name="relig1" class="form-control" id="relig1"  placeholder="Example:Islam">
  </div>
...
include("include/db.php");
  $total_num_results=23;
       ...
       $query=mysql_query("select * from mcs_eve_a"); //query to show results from.
